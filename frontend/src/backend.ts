...
export class Backend implements backendInterface {
    ...
    async adminGetAllContacts(): Promise<Array<[Principal, Array<ContactEntry>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetAllContacts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminGetAllNewsletterEmails(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetAllNewsletterEmails();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserContacts(arg0: Principal): Promise<Array<ContactEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserContacts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContactEntry(arg0: string, arg1: string, arg2: string, arg3: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactEntry(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
